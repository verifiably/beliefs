...
- 2026-09-07T14:32:13Z (main): Follow-up: CI is added and the TypeScript half is green on Node 20 and 24, but the Python jobs fail 183 of 3739 on a stock runner because the certified ext4 tuple is not available there. That is an environmental requirement, not a wiring fault, so it is filed separately as beliefs-0e7cb1 rather than reopening this. Runner timing for the record: 22m23s for the serial suite against 18m16s locally.
