...
Acceptance evidence: Wait for the acquisition (`beliefs-d13fe8`), mutation (`beliefs-aa27da`), world-read (`beliefs-b34652`), L13 (`beliefs-a7df71`), persistence (`beliefs-3ea822`), and publish (`beliefs-1a5157`) endpoints — the execution, domain, D1, estimand-typing and Nodes 2.0 endpoints (`beliefs-73be28`, `beliefs-bc3aff`, `beliefs-928881`, `beliefs-59f846`, `nodes-ce28b8`) are closed; design the successor identities and governance decisions; freeze before implementation; discharge N1–N10, P1 and the assigned certification/resolver/rules-store arms; update the authority artifacts and roadmap; and pass all Python, TypeScript, corpus, and parity gates.
...
Uncertainty: The roadmap fixes the join point, but successor identities, certification cadence, normative artifact shape, and legacy-check ruling need their design cycle. The base contract already carries one post-freeze amendment, the estimand grammar (cut 31); every remaining lane above amends at least one more oracle before the freeze.
...
- 2026-09-16T10:02:59Z (main): 2026-09-16 doc review: body no longer calls nodes-ce28b8 an unfinished blocker — it closed 2026-09-12 (nodes b0c37b8) and the ledger already says the join no longer waits on nodes. Six open endpoints remain: d13fe8, aa27da, b34652, a7df71, 3ea822, 1a5157.
