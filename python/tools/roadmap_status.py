...
ACCOUNTING: dict[int, tuple[str, str, str]] = {
    ...
    16: ("conformance-cut-16-results §2", "W5, G3, D7", "W16, C3, R23, M3, T2"),
    17: ("conformance-cut-17-results §1", "E1, E2, E3, E4, E5, E6, E7, E8", ""),
    18: ("conformance-cut-18-results §2", "G2c, G8, C6, R5, W16, M1, M5", "S5, R23, R19, R22, M3"),
    ...
    23: ("conformance-cut-23-results §2", "D3, S1, S1a, S5, W6, W10, R19", "R23"),
    24: ("conformance-cut-24-results §2", "W15, W4", "X12, W8a, M3"),
    25: ("conformance-cut-25 §4", "W1, W2, W5a", ""),
    26: ("conformance-cut-26-results §2", "D1", ""),
    ...
    36: ("conformance-cut-36-results §2", "L8, L4, L10", ""),
    37: ("conformance-cut-37-results §2", "L13", ""),
    38: ("conformance-cut-38-results §2", "T2", ""),
    39: ("conformance-cut-39-results §2", "W17, Y1, Y2, Y3, Y4", ""),
