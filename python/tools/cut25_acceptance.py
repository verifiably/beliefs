"""Run cut 25 after cut 24 on the certified durable tuple."""
...
DEFAULT_WORK = PYTHON_ROOT.parent / ".cut25-acceptance"

PREFIX_RUNNERS = ("cut24_acceptance.py",)
...
def declared_accounting() -> tuple[int, int, int]:
    ...
    from n2_arms_cut25 import CUT25_ARMS, DECLARATION_UNITS, unit_of  # pyright: ignore[reportMissingImports]

    return len(CUT25_ARMS), len(DECLARATION_UNITS), len({unit_of(arm.row) for arm in CUT25_ARMS})
