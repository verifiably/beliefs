"""Run cut 29 after cut 28 on the certified durable tuple."""
...
DEFAULT_WORK = PYTHON_ROOT.parent / ".cut29-acceptance"

PREFIX_RUNNERS = ("cut28_acceptance.py",)
...
def declared_accounting() -> tuple[int, int, int]:
    ...
    from n2_arms_cut29 import CUT29_ARMS, DECLARATION_UNITS, unit_of  # pyright: ignore[reportMissingImports]

    return len(CUT29_ARMS), len(DECLARATION_UNITS), len({unit_of(arm.row) for arm in CUT29_ARMS})
