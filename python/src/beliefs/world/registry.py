...
from beliefs.corpus import Finding, ReadView
...
class World:
    ...
    `beliefs.root` the one module that imports `atoms`.
    ...
    def admit(
        ...
        *,
        ...
        answer to report — `beliefs.root.admit_arrival` is the route that does,
