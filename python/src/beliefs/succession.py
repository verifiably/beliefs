...
one. It lives here and not in `beliefs.spec` because the derivation needs
...
from beliefs import verification as verification_module
from beliefs.errors import AdmissionEvidenceRefused, MalformedRecord, RecordUndecodable
