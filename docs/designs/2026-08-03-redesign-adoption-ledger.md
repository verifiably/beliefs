...
**Updated 2026-09-21** for cut 36's event-level L8 discharge, which closes
the boundary and its ride-along.

**Implemented through conformance cut 36.** Cuts 4–24 have discharge results
records under `../plans/`; cut 25 records discharge in its frozen cut document,
and cuts 26–36 record discharge in their dated results records, most recently
...
- **The event-level relation across captured corpus heads** — an event is
  ...
  The corpus has **186 of 216 rows closed**; the `world-read` lane's head is
  `act-report-remainder`.
...
(`../plans/2026-09-21-conformance-cut-36-results.md`) discharges event-level
...
6. **§9 log design** after the world-index packaging design settles the anchor.
   ...
   **Science's half implemented 2026-08-23** as world-index slice 3
   ...
   The preimage resolver behind L13's classification remains, with a named
