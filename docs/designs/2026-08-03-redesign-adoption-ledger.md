...
**Implemented through conformance cut 13.** Every cut from 4 onward has a
...
| `coordination-addressing` | W11, W12, W18; W17 except its intent-position clause; W13's two-projects negative | designed 2026-08-31 and amended 2026-09-02 (`../superpowers/specs/2026-08-31-coordination-and-view-kinds-design.md` §11, cut 14 frozen): minted through the adapter by a dedicated family door; joins the `mutation` lane at cut 13's re-rank; W17's intent-position evidence stays with `publish`, its first operational consumer | coordination references; W17's ordinary revision family |
...
(`../plans/2026-09-01-conformance-cut-13-results.md` §5) names R15, R4, R9,
R13, R16 and R21, and
