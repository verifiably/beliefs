...
6. **§9 log design** after the world-index packaging design settles the anchor.
   ...
   **Science's half implemented 2026-08-23** as world-index slice 3
   ...
   L6 unread. Intent qualification (L7's reduction, with G4), the preimage
   resolver behind L13's classification, event-level L8, and L10's fork,
   replica-construction, restore and store arms remain, each with a named
   owner in artifact 5's row.
