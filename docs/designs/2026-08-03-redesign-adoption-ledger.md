...
**Implemented through conformance cut 12.** Every cut from 4 onward has a
...
(`../plans/2026-08-29-conformance-cut-12-results.md` §5) names L8 and L13,
and `test_the_ledger_summary_names_the_newest_remaining_boundary` holds
